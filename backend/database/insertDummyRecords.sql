...
INSERT INTO tutor
    (uin, first_name, last_name, major_id, seniority_id, pay_rate, bio_text, picture_url, phone_number, email, average_rating)
VALUES
    ...
    (345678912, 'james', 'johnson', 3, 3, 20.00, 'Greetings', 'https://upload.wikimedia.org/wikipedia/commons/d/de/Kenneth_Harris_II.jpg', 9012345678, 'james@gmail.com', 3),
    (456789123, 'david', 'rodriquez', 4, 4, 25.00, 'Salutations', 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Updated-hs-zameer-rizvi-headshot-1.jpg/510px-Updated-hs-zameer-rizvi-headshot-1.jpg?20231107221652', 8901234567, 'david@gmail.com', 4),
    (567891234, 'mary', 'martinez', 5, 5, 30.00, 'Howdy', 'https://upload.wikimedia.org/wikipedia/commons/7/77/Melissa_Huang_headshot.jpg', 7890123456, 'mary@gmail.com', 5);
...
INSERT INTO appointment
    (appointment_type_id, tutor_id, tutee_id, appointment_date, start_time_id, end_time_id, location_id)
VALUES
    (1, 1, 1, '2024-03-01', 1, 2, 1),
    (1, 2, 2, '2024-03-02', 1, 3, 2),
    (1, 3, 3, '2024-03-03', 1, 4, 3),
    (1, 4, 4, '2024-03-04', 1, 5, 4),
    (1, 5, 5, '2024-03-05', 2, 3, 5);
...
INSERT INTO tutor_review
    (appointment_id, rating_id, review_text)
VALUES
    (1, 1, "very bad"),
    (2, 2, "somewhat bad"),
    (3, 3, "okay"),
